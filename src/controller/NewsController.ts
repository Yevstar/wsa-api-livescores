...
export class NewsController extends BaseController {
        ...
        if (isArrayPopulated(newsMedia)) {
          for (let i of newsMedia) {
            ...
            if (isPhoto(i.mimetype)) {
              ...
              let filename = `/media/news/${n.entityTypeId}_${n.entityId}_${
                n.title
              }_${timestamp()}.${fileExt(i.originalname)}`;
              ...
              if (fileUploaded) {
                ...
                return response
                  ...
                  .send({
                    errorCode: 6,
                    name: 'save_error',
                    message: 'News Image not saved, try again later.',
                  });
              }
              continue;
            }
              ...
              if (fileUploaded) {
                ...
                return response
                  ...
                  .send({
                    errorCode: 5,
                    name: 'save_error',
                    message: 'News Video not saved, try again later.',
                  });
              }
            }
          }
  ...
  async findUserNews(
    ...
    if (!user && !deviceId) {
      return response.status(400).send({
        name: 'bad_request',
        message: 'You must be authorized or sending device ID',
      });
    }
  ...
  async publishNews(
    ...
    if (news) {
      ...
      return response
        .status(400)
        .send({ name: 'search_error', message: `News with id ${id} not found` });
    }
  }
}
