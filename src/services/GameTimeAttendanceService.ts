...
export default class GameTimeAttendanceService extends BaseService<GameTimeAttendance> {
  ...
  public async count(matchId: number): Promise<number> {
    return this.entityManager
      .createQueryBuilder(GameTimeAttendance, 'gta')
  ...
  public async findByParam(
    ...
    let query = this.entityManager
      .createQueryBuilder(GameTimeAttendance, 'att')
  ...
  public async findPlayerByParamAndLast(
    matchId: number,
    teamId: number,
    playerId: number,
  ...
  public async deleteByMatchAndTeam(
    matchId: number,
    teamId: number,
    period: number,
    allPeriods: boolean = false,
    playerId: number,
